  ...
  return n({
    ...
    children: [
      ...
      n({
        ...
        children: [n({ id: `model.layers.${i}.self_attn.q_proj`, type: "linear", label: "q_proj", category: "linear" })],
      }),
    ...
    n({
      ...
      children: [
        n({
          ...
          has_internals: true,
          children: [
            n({ id: "model.embed_tokens", type: "embedding", label: "embed_tokens", category: "embedding", params: { num_embeddings: 128256 }, weight_shape: [128256, 2048], output_shape: "[B, S, 2048]" }),
            n({ id: "model.layers", type: "module_list", label: "layers", category: "container", has_internals: true, children: [layer(0), layer(1)] }),
